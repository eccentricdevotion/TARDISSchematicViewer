...
public enum Material {
    ...
    PRISMARINE(Color.cyan),
    PUMPKIN(Color.orange),
    PUMPKIN_STEM(Color.green),
    QUARTZ_BLOCK(Color.white),
    QUARTZ_ORE(Color.white),
    QUARTZ_STAIRS(Color.white),
    RAILS(Color.gray),
    REDSTONE_BLOCK(Color.red),
    ...
    SMOOTH_BRICK(Color.lightGray),
    SMOOTH_STAIRS(Color.lightGray),
    SNOW(Color.white),
    ...
    STONE_SLAB2(Color.lightGray),
    SUGAR_CANE_BLOCK(Color.green),
    THIN_GLASS(Color.green),
    TNT(Color.red),
    TORCH(Color.yellow),
